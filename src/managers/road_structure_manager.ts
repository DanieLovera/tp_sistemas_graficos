...
export class RoadStructureManager {
    ...
    render() {
        ...
        const colorMap = loader.load("public/textures/Road007_4K-JPG_Color.jpg");
        const normalMap = loader.load("public/textures/Road007_4K-JPG_NormalGL.jpg");
        const roughnessMap = loader.load("public/textures/Road007_4K-JPG_Roughness.jpg");

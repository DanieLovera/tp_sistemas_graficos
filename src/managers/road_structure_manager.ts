...
export class RoadStructureManager {
    ...
    render() {
        ...
        const colorMap = loader.load("/tp_sistemas_graficos/textures/Road007_4K-JPG_Color.jpg");
        const normalMap = loader.load("/tp_sistemas_graficos/textures/Road007_4K-JPG_NormalGL.jpg");
        const roughnessMap = loader.load("/tp_sistemas_graficos/textures/Road007_4K-JPG_Roughness.jpg");

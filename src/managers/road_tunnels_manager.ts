...
export class RoadTunnelsManager {
    ...
    createMeshes(geometries: RoadTunnelGeometry[]) {
        ...
        const colorMap = loader.load("src/textures/Concrete008_4K-JPG_Color.jpg");
        const aoMap = loader.load("src/textures/Concrete008_4K-JPG_AmbientOcclusion.jpg");
        const normalMap = loader.load("src/textures/Concrete008_4K-JPG_NormalGL.jpg");
        const roughnessMap = loader.load("src/textures/Concrete008_4K-JPG_Roughness.jpg");
